...
namespace FLIPFluidSimulator
{
    ...
    public class FLIPFluidScene : EulerianFluidSimulator.FluidScene
    {
        public new FLIPFluidSim fluid = null;
        ...
        public FLIPFluidScene(Material fluidMaterial) : base(fluidMaterial)
        {
